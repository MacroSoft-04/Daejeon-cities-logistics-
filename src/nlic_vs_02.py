...
* visualizaiton:
    - Butterfly Chart
* Output:
    - 02_dj_cargo_flow_shift_ko.jpg
    - 02_dj_cargo_flow_shift_en.jpg
====================================================================
"""
...
# 1. Load Data
data_map = {
    "21_22": pd.read_csv(data_dir / "nlic_dj_cargo_flow_shift_21_22_vs02.csv"),
    "22_23": pd.read_csv(data_dir / "nlic_dj_cargo_flow_shift_22_23_vs02.csv"),
}
...
I18N = {
    "ko": {
        ...
        "info_box": "* Y: 도시 (권역)  |  단위: 만 톤\n* 수도권: 서울/경기/인천 통합",
        "filename": "02_dj_cargo_flow_shift_ko.jpg",
    },
    "en": {
        ...
        "etc_replace": (
            r"Others \(13 Local Govs\)\(Others\)",
            "Others (13 Local Govs)",
        ),
        "type_map": {"출발": "Departure", "도착": "Arrival"},
        "year_map": {"21_22": "2021 vs 2022", "22_23": "2022 vs 2023"},
        "info_box": "* Y: City (Region)  |  Unit: 10k Tons\n* Capital Area: Seoul/Gyeonggi/Incheon",
        "filename": "02_dj_cargo_flow_shift_en.jpg",
    },
}
    ...
    for year_key, df in data_map.items():
        ...
        for gubun, row_i in row_idx_map.items():
            ...
            plot_data["도시_권역"] = np.where(
                ...
                plot_data[
                    c_col
                ],  # Keep as '수도권(서울/경기)' without attaching region again
