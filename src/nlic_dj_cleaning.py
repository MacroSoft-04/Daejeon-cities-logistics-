...
df = pd.read_csv(data_dir / "Deajeon_data_logistics_total.csv")
...
df_final.to_csv (f"{data_dir}/Deajeon_data_logistics_cleaned.csv", index=False, encoding='utf-8-sig') # save the final DataFrame to a CSV file